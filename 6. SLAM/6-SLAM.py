...
class matrix:
    ...
    def show(self, txt = ''):
        ...
        for i in range(len(self.value)):
            print('['+ ', '.join('%.3f'%x for x in self.value[i]) + ']\n') 
        print(' ')
...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    print('\nLength of path N: {}, num_landmarks: {}, dim: {}'.format(N, num_landmarks, dim))


    # Make constraint info matrix and vector
    omega = matrix()
    omega.zero(dim, dim)
    omega.value[0][0] = 1.0
    omega.value[1][1] = 1.0
...
##    xi.show('xi: \n')
    ...
    for k in range(len(data)):
        # index of robots pose in matrix/vector
        n = k * 2
...
##        print('motion: ', motion)
        ...
        for i in range(len(measurement)):
            # m is the index of Landmark coord in matrix/vector
            m = (N + measurement[i][0]) * 2
...
# Output
# ('Landmarks: ', [[61.0, 14.0], [6.0, 46.0], [72.0, 45.0], [61.0, 62.0], [59.0, 93.0]]) Robot: [x=56.93676 y=94.82355]

# Length of path N: 20, num_landmarks: 5, dim: 50 ('size of data: ', 19)

# Estimated Pose(s): [49.997, 49.996] [34.920, 36.465] [22.890, 23.130] [9.575, 8.258] [11.991, 28.427] [15.042, 49.236] [16.602, 70.885] [18.024, 92.348] [9.206, 76.321] [6.145, 95.350] [23.172, 82.573] [40.259, 71.092] [56.804, 60.421] [72.216, 47.645] [88.420, 35.066] [75.227, 50.969] [62.556, 66.291] [50.908, 81.687] [38.573, 96.976] [57.778, 91.395]

# Estimated Landmarks: [59.954, 13.648] [6.356, 45.021] [71.880, 43.264] [60.586, 60.141] [59.377, 91.600]

# Length of path N: 20, num_landmarks: 5, dim: 50 ('size of data: ', 19)

# Estimated Pose(s): [49.999, 49.999] [37.971, 33.650] [26.183, 18.153] [13.743, 2.114] [28.095, 16.781] [42.383, 30.900] [55.829, 44.494] [70.855, 59.697] [85.695, 75.540] [74.010, 92.431] [53.543, 96.451] [34.523, 100.078] [48.621, 83.951] [60.195, 68.105] [73.776, 52.932] [87.130, 38.536] [80.301, 20.506] [72.797, 2.943] [55.244, 13.253] [37.414, 22.315]

# Estimated Landmarks: [82.954, 13.537] [70.493, 74.139] [36.738, 61.279] [18.696, 66.057] [20.633, 16.873] [[49.998897453299165], [49.998505706587814], [37.9714477943764], [33.64993445823509], [26.183449863995392], [18.153338459791925], [13.743443839776688], [2.1141193319706257], [28.095060682659934], [16.78089653056425], [42.382654337758865], [30.899617637854934], [55.82918373374959], [44.494287384838586], [70.85548928962663], [59.69712516287841], [85.6953531635832], [75.54007207500423], [74.00974406829611], [92.43147558585063], [53.54264788322474], [96.45111370814985], [34.52341231228876], [100.07762713840204], [48.621309970082486], [83.95097871134821], [60.19521941022714], [68.1050904555393], [73.77592978594885], [52.932451315943574], [87.12997140410576], [38.53576961176431], [80.3007799395094], [20.505859780712917], [72.79656231764604], [2.942675607797428], [55.243590482706026], [13.253021809459227], [37.41439688492312], [22.31502245240636], [82.95425645256424], [13.536536707427121], [70.49306062345174], [74.13913606764582], [36.73812342335858], [61.2789905549488], [18.696326102039485], [66.05733561281015], [20.632945056999347], [16.87255837889543]]
